...
- Structure: short hook → **Key lessons** (the takeaways stated up front, before the supporting detail — a reader should get the point even if they stop there) → historical/literary context → walk-through with original-language notes → theological principle → discussion questions → **References & Recommended Reading**.
