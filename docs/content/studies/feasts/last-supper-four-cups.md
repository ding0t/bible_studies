...
At the Last Supper, Jesus says some version of "I will not drink again of the fruit of the vine until [the kingdom of God comes / I drink it new with you in my Father's kingdom]" (Matthew 26:29; Mark 14:25; Luke 22:18). The question worth asking before drawing any conclusion: **is there something specific about the structure of the Passover meal that this statement is keyed to?**

The short answer, checked against primary and secondary sources rather than assumed: the Passover Seder is traditionally structured around **four** cups of wine, not two — and which cup Jesus's statement refers to is a real, interesting question the Gospels themselves don't answer explicitly. This study works through the evidence rather than the popular version of the story.
...
**Luke (22:14-20)** is different, and it's worth reading closely rather than flattening into Matthew/Mark's shape. Luke narrates **two** cups:
...
- **"Covenant"** (διαθήκη, *diathēkē*, G1242) in "new covenant in my blood" is doing double duty, echoing two Old Testament texts at once. It's a direct echo of Jeremiah's promise — *"Behold, the days are coming, declares the LORD, when I will make a new covenant with the house of Israel"* (Jeremiah 31:31, ESV) — but the specific phrase "blood of the covenant" (Matthew 26:28; Mark 14:24) also echoes Moses at Sinai: *"Behold the blood of the covenant that the LORD has made with you"* (Exodus 24:8, ESV), spoken as Moses threw sacrificial blood on the people to ratify the first covenant. Jesus is not only claiming Jeremiah's promised new covenant is now being enacted — he's using Moses's own covenant-ratification words to do it, positioning this meal as a Sinai-scale covenant-inaugurating event, not simply a memorial.
...
One popular devotional connection is worth mentioning by name, precisely because it's popular and worth being honest about its status: the suggestion that Jesus's vow is finally "completed" when he receives sour wine on the cross (John 19:28-30) just before saying "It is finished." It's a striking reading, and not unreasonable — but this study did not find it resting on established scholarly consensus, only on popular and devotional sources. It's included here as a suggestion worth thinking about, not as a conclusion the text itself draws.
