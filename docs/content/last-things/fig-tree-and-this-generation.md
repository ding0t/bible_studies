...
category: "prophecy"
description: "Matthew 24:32-34: the fig tree parable teaches inference from signs, and \"this generation\" is the generation that sees them -- no species code, and no year to count from."
tags: ["matthew", "luke", "dispensationalism", "method/word-study", "lang/greek"]
draft: true
primary_passage: "Matthew 24:32-34"
...
One distinction needs care, because the date-setting reading sounds like this one.
...
Programme](immediately-after.md#where-the-discourse-sits-in-gods-whole-programme).
