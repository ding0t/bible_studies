...
- **The standard rabbinic (lunisolar) calendar** — the one most Jewish and Christian sources mean by
  ...
  **civil year beginning in Tishri** (fall) — with months measured by the ~29.5-day lunar cycle. A
  ...
  pages for more on the new-moon reckoning and the Nisan-1 "biblical new year" question. To resync
  the 354-day lunar year with the 365-day solar year, a leap month (**Adar II**) is inserted seven
...
- Associates for Biblical Research, on the Kurkh Monolith, Sennacherib's Prism, and the Assyrian
  Eponym Canon: [biblearchaeology.org](https://biblearchaeology.org)
- Livius.org, ["ABC 5 (Jerusalem
  Chronicle)"](https://www.livius.org/sources/content/mesopotamian-chronicles-content/abc-5-jerusalem-chronicle/)
- Ernst Weidner (trans.), the Jehoiachin Ration Tablets — see the summary at [Bible Archaeology
  Report](https://biblearchaeologyreport.com/2020/11/13/king-jehoiachin-an-archaeological-biography/)
- The Cyrus Cylinder and Nabonidus Chronicle — British Museum
- Sir Robert Anderson, *The Coming Prince* (1894) — the classic 173,880-day calculation
- Harold W. Hoehner, *Chronological Aspects of the Life of Christ* (Zondervan, 1977) — the
  standard evangelical refinement of Anderson's arithmetic, and its own critics' technical
  objections
...
- Sacha Stern, *Calendar and Community: A History of the Jewish Calendar, 2nd Century BCE - 10th
  ...
  it replaced
- James C. VanderKam, *Calendars in the Dead Sea Scrolls: Measuring Time* — on 1 Enoch's
  Astronomical Book (c. 3rd century BC) and Jubilees' (mid-2nd century BC) development of the
  364-day calendar, and Jubilees' own framing of it as a restoration against a lunar "corruption"
- Colin J. Humphreys and W. G. Waddington, "Dating the Crucifixion," *Nature* 306 (1983) — the
  3 April AD 33 lunar eclipse calculation
- Bradley E. Schaefer, "Lunar Visibility and the Crucifixion," *Quarterly Journal of the Royal
  Astronomical Society* 31 (1990) — the peer-reviewed rebuttal on how little of that eclipse would
  actually have been visible
- Colin J. Humphreys and W. G. Waddington, "Solar eclipse of 1207 BC helps to date pharaohs,"
  *Astronomy & Geophysics* 58 (2017) — the Joshua 10 / Gibeon eclipse reinterpretation
- Michael R. Molnar, *The Star of Bethlehem: The Legacy of the Magi* (Rutgers University Press,
  1999) — the Jupiter-occultation theory, one of several competing Star of Bethlehem proposals
