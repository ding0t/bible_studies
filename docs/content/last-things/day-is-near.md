...
James writes this to believers under real economic pressure. The paragraph immediately before it
(5:1-6) condemns wealthy landowners who have cheated their labourers of wages, and 5:7 opens with
"therefore" — tying patience to that injustice rather than to abstract waiting.

**Be patient** translates **μακροθυμήσατε** (*makrothymēsate*, from **μακροθυμέω**, *makrothymeō*,
G3114), literally "long-tempered". It is a patience aimed at people and circumstances rather than at
pain. Greek keeps a separate word for endurance under suffering, *hypomonē*, and James uses both in
this passage, at 5:8 and 5:11.

The farmer's image sharpens it. He cannot make rain fall or grain ripen faster by wanting it. That
...
Verse 8's answer to the delay is **one day is as a thousand years** (**ἡμέρα... ὡς χίλια ἔτη**). It
is introduced with **ὡς** (*hōs*, "like/as," G5613) — a comparison, not an equation.

**παρὰ κυρίῳ** ("with the Lord," G3844) is **παρά** with the dative: beside, in the presence of, in
the judgment of someone. MACULA glosses it here simply "with [the] Lord." So the statement sits
inside the Lord's own reckoning of time. That is not the same claim as God standing outside time
altogether.

Psalm 90, the psalm Peter is drawing on, rules the stronger claim out from its own side. Eight
verses after "a thousand years in your sight are but as yesterday," it asks God "Return, O LORD! How
...
The verse uses two different Hebrew roots for God's rest: <span dir="rtl">וַיָּנַח</span> (*vayyanach*, "he rested," from <span dir="rtl">נוּחַ</span>, *nuach*, H5117) describes the act, and <span dir="rtl">שַׁבָּת</span> (*shabbat*, "Sabbath," H7676) names the day set apart because of it. Both trace to the same underlying idea of cessation -- TWOT roots the noun *shabbat* in the verb <span dir="rtl">שָׁבַת</span> (*shabat*, "cease," H7673, TWOT root 2323) -- so the day isn't merely associated with rest, its name *is* the word for stopping.
...
Hebrews does not itself connect this Sabbath rest to a future millennial reign. The connection drawn
in the next two sections is an inference from shared vocabulary and pattern — six days, then a
seventh, echoed in the millennium's own "thousand years". Hebrews 4 does not make that claim
explicitly. It is the same distinction the previous section drew for 2 Peter 3:8.
...
**χίλια ἔτη** (*chilia etē*, "a thousand years") is repeated six times across these six verses.
Revelation is the only place in Scripture that names a specific duration for this reign. That is why
...
The Sabbath is a type of a coming rest (Hebrews 4; Colossians 2:16-17), and this millennium is the
one specific "rest" Scripture actually numbers. So the typological line runs: Sabbath → the church's
present rest by faith → this future thousand-year reign as its consummation.
...
The disciples ask two questions, not one: *when*, and *what sign*. Jesus never directly answers
"when" (see [Be patient while the time is hidden](#be-patient-while-the-time-is-hidden) above). What
follows is his answer to the second question, spoken privately (**κατ᾽ ἰδίαν**) on the Mount of
Olives. That is why the whole discourse is called the Olivet Discourse (Matthew 24-25; the Mark 13
passage studied above is its parallel).
...
Jesus's own label for this list matters more than the list itself: **birth pains** (**ὠδίνων**,
*ōdinōn*). Old Testament prophets already used labour pains as a stock image for intense,
unavoidable suffering that precedes deliverance (Isaiah 13:8; 26:17-19; Jeremiah 22:23; Micah
4:9-10).

The image carries its own warning against premature alarm. Contractions that come and go are not yet
the birth.

So false messiahs, wars, famines and earthquakes are named as the *beginning*, and explicitly not as
the sign (v. 8). Jesus is drawing the disciples' urgency down, not up — at exactly the point a
reader is tempted to treat any war or earthquake as the sign itself.
