---
title: "The Scribe Trained for the Kingdom"
category: "bible"
...
Jesus spends a whole afternoon telling parables, asks the Twelve whether they have followed
any of it, and they say yes. What He says next is the last line of the discourse, and He says
it about them.

> ✝️ Matthew 13:51-52 (ESV)
>
> 51 "Have you understood all these things?" They said to him, "Yes." 52 And he said to them,
...
Father, You are the God who teaches. You opened the disciples' ears when the crowd's stayed
shut, and You have done the same for me — I did not earn a word of what I understand. Thank You
for Your Son Jesus, who took twelve ordinary men and made them scribes of Your kingdom. Fill my
storeroom, Lord: with the promises You made to Israel and the Gospel You have now revealed, and
let me love both halves. Then send me out with my hands full, and make me generous with what
You have given. In Jesus' name. Amen.
...
of heaven" 31 times against 4 uses of "the kingdom of God." Mark and Luke write "the kingdom of
God" 14 and 31 times and "the kingdom of heaven" never (counts from the SBLGNT). That
circumlocution is what a Jewish readership would expect. So when Jesus reaches for a scribe and a
household storeroom to describe His disciples, Matthew's first readers knew both pictures from
the inside.
...
you speak to them in parables?" (13:10, ESV). His answer divides the room.

> ✝️ Matthew 13:11 (ESV)
>
> 11 And he answered them, "To you it has been given to know the secrets of the kingdom of
> heaven, but to them it has not been given."

Jesus then grounds that division in Isaiah. Matthew 13:14-15 quotes Isaiah 6:9-10 at length —
...
> ✝️ Ezra 7:6 (WEB)
>
> 6 this Ezra went up from Babylon. He was a skilled scribe in the law of Moses, which Yahweh,
> the God of Israel, had given; and the king granted him all his request, according to Yahweh
> his God's hand on him.

"Skilled scribe" is <span dir="rtl">סֹפֵר מָהִיר</span> (*sofer mahir*), which the Septuagint
renders γραμματεὺς ταχύς — "a quick scribe," my own rendering of the Greek (Ezra 7:6, Septuagint
text from Brenton's edition; no English Brenton is quoted here). Four verses later the Hebrew
gives the job description as three infinitives: <span dir="rtl">לִדְרוֹשׁ</span> (*lidrosh*,
to study), <span dir="rtl">וְלַעֲשֹׂת</span> (*vela'asot*, and to do),
...
trained in the Law of Moses, and teaching it to others. These were respected men, and they
...
γραμματεύς appears **22 times in Matthew**. They are with the chief priests when Herod hunts
the infant Christ (2:4). They are the benchmark of an insufficient righteousness (5:20). They
are the foil for Jesus's own authority in 7:29, the ones who say "this man is blaspheming"
(9:3, ESV), the demanders of a sign (12:38), and the addressees of six woes in chapter 23
(23:13, 15, 23, 25, 27, 29). Twice a scribe stands somewhere else. In 8:19 one walks up and
says, "Teacher, I will follow you wherever you go" (ESV). And in 23:34, at the bottom of the
woes, Jesus says this:
...
Jesus has scribes of His own, and He sends them. The Macula linguistic annotation of the Greek
New Testament — an open-licensed scholarly dataset, so a considered judgement by its editors —
...
| Reference | Form | Who |
|---|---|---|
| Matthew 13:52 | μαθητευθείς, aorist passive | the scribe of the kingdom |
| Matthew 27:57 | ἐμαθητεύθη, aorist passive | Joseph of Arimathea |
| Matthew 28:19 | μαθητεύσατε, aorist active imperative | the Eleven, commanded |
| Acts 14:21 | μαθητεύσαντες, aorist active | Paul and Barnabas, in Derbe |

Matthew's Gospel opens this word in the passive and closes it in the active. In 13:52 the
...
The Greek is a bare dative, τῇ βασιλείᾳ τῶν οὐρανῶν, with no preposition at all. Greek can
leave the relation unstated. English cannot, so every translation committee has to choose one.
Fourteen versions produce eleven wordings and seven different relations:

| Rendering | Versions |
|---|---|
| trained **for** the kingdom | ESV |
| become a disciple **of** the kingdom | NASB 1995, NASB 2020, LSB |
| become a disciple **in** the kingdom | NIV, CSB |
| discipled **in** the kingdom | BSB |
| made a disciple **in** the Kingdom | WEB |
| made a disciple **to** the kingdom | ASV |
| instructed **unto** the kingdom | KJV |
| taught **unto** the kyngdome | Tyndale (1526) |
| discipled **unto** the kingdom | Rotherham |
...
Read the verse with the dative left open and it says something larger than any single
...
arrangements, with the promises made to Israel staying Israel's (see
[Dispensationalism](../glossary.md#dispensationalism) and
...
casts out demons by Beelzebul (12:23-24). He warns them about a blasphemy that will not be
forgiven (12:31), refuses them a sign beyond Jonah's (12:39), and redefines His family around
"whoever does the will of my Father in heaven" (12:50, ESV). Then: "That same day Jesus went out
...
Pull the five words together and the verse describes a person.

A **scribe** — trained in the Scriptures, able to handle a text. **Discipled** — trained by
Jesus, in the passive, as a gift. Of and for and in the **kingdom** — its subject, its purpose,
its home. A **householder** with a stocked **storeroom** — a store filled before it was needed.
...
opens the door. So you may teach your children, answer your friend, and open your Bible in
front of someone this week with something in your hands — because He put it there.
...
2. The disciples say "Yes" in verse 51, and Jesus's "therefore" in verse 52 hangs on that yes.
   ...
   yes true, and how much of it was their doing?

3. Fourteen English versions supply seven different relations for a Greek dative that supplies
   none (see the table above). If you had to pick one — trained *for*, disciple *of*, disciple *in* —
   which would you choose, and what does your choice commit you to about what discipleship is?

4. Matthew 9:17 says new wine bursts old wineskins. Matthew 13:52 says the householder carries
   out new and old together. How do you hold those two sentences at once, and where have you
   seen a church get one of them wrong?

5. Jesus uses the word μυστήριον once in the Gospels, at Matthew 13:11, and Matthew dates the
   whole discourse to "that same day" (13:1) — the day of the confrontations in chapter 12. What
   does it commit you to if the parables were given *because* the King had just been refused?
   What changes if they were not?

6. Matthew 12:35 says a man brings out of his treasure what he has stored there. Take that as a
   question about your own shelves: if someone listened to everything you said about God this
   month, what would the inventory look like — and which half of the storeroom is thin?
...
- *SBL Greek New Testament* (CC BY 4.0) — the Greek text of Matthew quoted and parsed here.
- *MACULA Greek Linguistic Datasets (SBLGNT)* (CC BY 4.0) — morphology and Louw-Nida semantic
  domains. Domain assignments are scholarly judgements by the dataset's editors, and are
  labelled as such wherever this study leans on one.
- *World English Bible* (public domain) — quotations labelled WEB.
- *Westminster Leningrad Codex* / *unfoldingWord Hebrew Bible* (public domain; CC BY-SA 4.0) —
  the Hebrew of Ezra 7.
- *Brenton Septuagint* (public domain) — Ezra 7:6, 7:11 in Greek.
- *American Standard Version*, *Berean Standard Bible*, *King James Version*, *Tyndale New
...
- *The Holy Bible, English Standard Version* (Crossway, 2016) — this site's default, and the
...
- *ESV Study Bible* (Crossway, 2016) — introduction to Matthew on authorship and the early
  testimony of Papias and Irenaeus; notes on 13:10-11 and 13:51-52.
- *NIV Cultural Backgrounds Study Bible* and *NKJV Cultural Backgrounds Study Bible*
  (Zondervan; John H. Walton and Craig S. Keener, eds.) — notes on Matthew 5:20 (what a
  first-century scribe was), 7:29 (citing earlier authorities), and 13:52.
- *NIV Biblical Theology Study Bible* (Zondervan) — note on 13:52.
- *NLT Life Application Study Bible, Third Edition* (Tyndale House, 2019) — note on 13:52.
- *CSB Ancient Faith Study Bible* (Holman) — translators' footnote at 13:52, "Or every scribe."
- Gordon D. Fee and Douglas Stuart, *How to Read the Bible for All Its Worth* — the exegesis-
  before-hermeneutics method behind this study, and the rule for parables followed here: find
...
- [How to Read the Bible](how-to-read-the-bible.md) — the method this study follows.
- [Original Language Data](original-language-data.md) — where the Greek and Hebrew data above
  comes from and how to query it yourself.
- [Israel and the Church](../israel-and-church/israel-and-the-church.md) — the site's working-out
  of μυστήριον from Daniel 2 through Ephesians 3 and Romans 11, which the dispensational section
  above leans on rather than repeating.
- [Glossary: Dispensationalism](../glossary.md#dispensationalism) — the framework named, and the
  οἰκονομία behind the name.
