...
tags: ["matthew", "mark", "luke", "john", "jonah", "leviticus", "psalms", "ephesians", "1-samuel", "1-thessalonians", "crucifixion", "resurrection", "chronology", "method/typology", "method/word-study", "lang/greek", "lang/hebrew"]
draft: false
...
Four things. **The direction is up, out of the earth.** <span dir="rtl">עָלָה</span> (*ʿalah*,
...
<span dir="rtl">לְהַעֲלוֹת</span>, its hiphil. It is the same verb Jonah uses when God "brought up
...
*disturbed* me," <span dir="rtl">רָגַז</span> (*ragaz*), to be agitated. And the woman calls what
...
```mermaid
flowchart TD
    subgraph BEF["Before the resurrection · a chasm fixed between · Luke 16:26"]
      direction LR
      B1["<b>Abraham's side</b><br/>the righteous dead,<br/>comforted<br/>Luke 16:22"]
      B2["<b>torment</b><br/>the unrighteous<br/>Luke 16:23"]
      B1 ~~~ B2
    end
    subgraph NOW["Now · since the ascension"]
      direction LR
      N1["<b>with Christ</b>,<br/>away from the body,<br/>conscious, waiting,<br/><i>still unclothed</i><br/>2 Cor 5:8 · Rev 6:9"]
      N2["<b>torment</b>,<br/>still occupied<br/>Rev 20:13"]
      N1 ~~~ N2
    end
    subgraph FIN["At his coming, and after"]
      direction LR
      F1["<b>raised imperishable</b><br/>the body, out<br/>of the grave<br/>1 Cor 15:53"]
      F2["Death and Hades<br/>into the lake of fire<br/>Rev 20:14"]
      F1 ~~~ F2
    end
    BEF --> NOW
    NOW --> FIN
