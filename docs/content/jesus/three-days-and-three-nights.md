...
category: "theology"
description: "A Friday crucifixion gives two nights, not three. Whether Matthew 12:40 rules it out — the one occurrence of the phrase, the eight that say 'on the third day', Mark's word for the day, and the 'high day' that carries the Wednesday case."
...
Jesus said he would be "three days and three nights in the heart of the earth." A Friday afternoon
death and a Sunday dawn resurrection gives two nights. Either the tradition has the wrong day, or
the phrase is not doing the work a modern reader assumes.
...
not left to spot it (Matthew 12:40, drawing on Jonah 1:17, which the Hebrew numbers 2:1). What the
type carries is burial and emergence, not a stopwatch: Jesus calls it "the sign of Jonah" in the
same breath, and a sign is a thing pointed at rather than a duration measured.
