...
The calendar structure above says nothing about *when* the count starts. That is a separate
...
All four scenarios and their arguments each way are recorded in
